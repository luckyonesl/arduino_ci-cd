...
export DOCKERCLOUDCONNECTION='unix:///Users/stefan/Library/Containers/com.docker.docker/Data/docker.raw.sock'
...
export SHAREDLIBREP=/Volumes/FRITZ.NAS/storage1/Software/jenkins_shared_lib.git
echo "SHAREDLIBREP ${SHAREDLIBREP}"
#export ARDOINOREP=/Volumes/FRITZ.NAS/storage1/Software/Ardoino/ardoino_projects
export ARDOINOREP='gitolite3@192.168.2.101:ardoino_projects' 
